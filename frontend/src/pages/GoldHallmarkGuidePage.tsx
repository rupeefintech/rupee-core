      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gradient-to-br from-yellow-600 via-yellow-500 to-amber-500 text-white px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <nav className="flex items-center gap-1.5 text-yellow-100 text-xs mb-5">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-white">Gold Hallmark Guide</span>
            </nav>
            <h1 className="text-3xl sm:text-4xl font-bold mb-3">BIS Gold Hallmark Guide India</h1>
            <p className="text-yellow-100 text-lg">What 916, 750, 585 and other hallmarks mean before you buy</p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          <section className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-3">What is a BIS Hallmark?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              A <strong>BIS hallmark</strong> is a purity certification mark issued by the <strong>Bureau of Indian Standards (BIS)</strong> on gold jewellery. It guarantees that the gold has been independently tested and certified to meet the declared purity standard. BIS hallmarking became <strong>mandatory in India from June 2021</strong>.
            </p>
            <div className="bg-yellow-50 border border-yellow-100 rounded-xl p-4 text-sm">
              <p className="font-semibold text-yellow-800 mb-2">A BIS hallmark contains 4 components:</p>
              <ol className="space-y-1 text-yellow-700">
                <li><strong>1.</strong> BIS logo (triangle with the letters BIS)</li>
                <li><strong>2.</strong> Purity/fineness mark (e.g., 916, 750)</li>
                <li><strong>3.</strong> HUID — Hallmark Unique Identification Number (6-character alphanumeric)</li>
                <li><strong>4.</strong> Jeweller's identification mark</li>
              </ol>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
            <div className="px-6 py-4 border-b border-gray-100">
              <h2 className="text-xl font-bold text-gray-900">Gold Hallmark Purity Chart</h2>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-5 py-3 text-left font-semibold text-gray-600">Hallmark</th>
                    <th className="px-5 py-3 text-left font-semibold text-gray-600">Karat</th>
                    <th className="px-5 py-3 text-left font-semibold text-gray-600">Purity</th>
                    <th className="px-5 py-3 text-left font-semibold text-gray-600">Common Use</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={h} className={highlight ? 'bg-yellow-50' : 'hover:bg-gray-50'}>
                      <td className="px-5 py-3 font-mono font-bold text-yellow-700 text-lg">{h}</td>
                      <td className="px-5 py-3 font-semibold text-gray-800">{k}</td>
                      <td className="px-5 py-3 text-gray-700">{p}</td>
                      <td className="px-5 py-3 text-gray-500 text-xs">
                        {u}
                        {highlight && <span className="ml-2 bg-yellow-200 text-yellow-800 text-xs px-1.5 py-0.5 rounded font-semibold">Standard</span>}
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          {/* 916 deep dive */}
          <section className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Why is 916 the Most Popular Hallmark in India?</h2>
            <div className="space-y-3 text-sm text-gray-600">
              <p>The <strong>916 hallmark (22 karat)</strong> is the gold standard for jewellery in India because it strikes the ideal balance between purity and durability:</p>
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={t} className="flex gap-2.5 p-3 bg-gray-50 rounded-xl">
          ...
          {/* HUID */}
          <section className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-3">What is HUID — Hallmark Unique ID?</h2>
            <p className="text-gray-700 text-sm leading-relaxed mb-4">
              The <strong>HUID (Hallmark Unique Identification Number)</strong> is a 6-character alphanumeric code stamped on every BIS-hallmarked gold jewellery item since April 2023. It allows consumers and authorities to verify the authenticity of the hallmark by checking the HUID against the BIS database.
            </p>
            <div className="bg-gray-50 rounded-xl p-4 text-sm">
              <p className="font-semibold text-gray-800 mb-2">How to verify HUID:</p>
              <ol className="space-y-1 text-gray-600 list-decimal ml-4">
          ...
          {/* Buying tips */}
          <section className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Tips for Buying Hallmarked Gold in India</h2>
            <div className="space-y-3">
              {[
                ...
                <div key={n} className="flex gap-3">
                  <span className="w-7 h-7 rounded-full bg-yellow-100 text-yellow-800 flex items-center justify-center text-sm font-bold shrink-0 mt-0.5">{n}</span>
                  <div>
          ...
          <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-6 text-center">
            <p className="text-yellow-800 font-semibold mb-3">Check today's live 22K & 24K gold rate before you buy</p>
