    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-brand-50">
        <div className="bg-gradient-to-br from-brand-700 to-brand-900 text-white py-10 px-4 text-center">
          ...
          <p className="text-brand-100 text-sm max-w-md mx-auto">Calculate expected returns on your lumpsum mutual fund investment. Compare across fund categories.</p>
        </div>
