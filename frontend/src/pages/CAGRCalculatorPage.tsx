    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white py-10 px-4 text-center">
          ...
          <p className="text-blue-100 text-sm max-w-md mx-auto">Calculate the Compound Annual Growth Rate of any investment instantly.</p>
        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-7 pr-4 py-3 border rounded-lg text-slate-800 font-semibold focus:outline-none text-sm ${!P ? 'border-red-300 bg-red-50 focus:border-red-400' : 'border-slate-200 focus:border-blue-400'}`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-7 pr-4 py-3 border rounded-lg text-slate-800 font-semibold focus:outline-none text-sm ${!F ? 'border-red-300 bg-red-50 focus:border-red-400' : 'border-slate-200 focus:border-blue-400'}`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="e.g. 5"
                      className={`w-full pr-10 pl-4 py-3 border rounded-lg text-slate-800 font-semibold focus:outline-none text-sm ${!N ? 'border-red-300 bg-red-50 focus:border-red-400' : 'border-slate-200 focus:border-blue-400'}`}
                    />
              ...
              <div className="flex flex-col gap-4">
                ...
                {isValid && (
                  <div className="bg-slate-50 rounded-xl p-4 space-y-2">
                    ...
                    <div className="flex justify-between text-sm"><span className="text-slate-500">CAGR (Annualised)</span><span className={`font-bold ${cagr >= 0 ? 'text-blue-600' : 'text-red-600'}`}>{cagr.toFixed(2)}%</span></div>
                  ...
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody>
                      {compRates.map(r => {
                        ...
                        const gain = val - P;
                        return (
                          <tr key={r} className={`border-t border-slate-50 hover:bg-slate-50 ${Math.abs(cagr - r) < 0.5 && isValid ? 'bg-blue-50' : ''}`}>
                            <td className="px-4 py-3 font-bold text-blue-600">{r}%</td>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                <p className="font-semibold text-blue-800 mb-2">Formula</p>
                <code className="block bg-white rounded px-3 py-2 text-blue-700 font-mono text-sm">CAGR = [(Final Value ÷ Initial Value)^(1÷N) − 1] × 100</code>
                <p className="text-xs text-blue-600 mt-2">Where N = number of years</p>
              </div>
